...
export default function Achievements() {
  ...
  const achievements = {
    ar: [
      {
        year: '2026',
        title: 'المركز الأول في المسابقة الوطنية',
        description: 'تفوق طلابنا في المسابقة العلمية الوطنية',
        icon: Trophy,
      ...
      {
        year: '2025',
        title: 'جائزة التميز التربوي',
        description: 'حصول المدرسة على جائزة التميز من وزارة التربية',
        icon: Award,
      ...
      {
        year: '2024',
        title: '100% نجاح في الشهادة الثانوية',
        description: 'تحقيق نسبة نجاح كاملة لطلاب الثانوية العامة',
        icon: Target,
      ...
      {
        year: '2023',
        title: 'اعتماد دولي للمناهج',
        description: 'حصول المدرسة على الاعتماد الأكاديمي الدولي',
        icon: Zap,
